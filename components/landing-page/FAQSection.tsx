...
export default function FAQSection() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "You will get access to 17+ leading job platforms. We aggregate jobs from platforms like Y Combinator, Indeed, Greenhouse, Wellfound, RemoteOK, We Work Remotely, Naukri, Uplers and VCs like a16z, Lightspeed, Khosla, Sapphire, Accel and more on a daily basis so that you have access to the latest jobs posted all across the globe.",
    },
    {
